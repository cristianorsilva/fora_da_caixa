...
import 'package:fora_da_caixa/presenters/pix/pix_transfer_recipient_view.dart';
...
class TransferValueView extends StatefulWidget {
  ...
  const TransferValueView({Key? key, required this.user, required this.pageTitle, required this.userTransaction, required this.listUserAccount})
      : super(key: key);

  @override
  _TransferValueViewState createState() => _TransferValueViewState();
}

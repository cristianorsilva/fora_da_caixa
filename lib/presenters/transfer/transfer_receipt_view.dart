...
class TransferReceiptView extends StatefulWidget {
  ...
  const TransferReceiptView(
      {Key? key, required this.userTransaction, required this.userFrom, required this.userTo, required this.fromAccountView})
      : super(key: key);

  @override
  _TransferReceiptViewState createState() => _TransferReceiptViewState();
}

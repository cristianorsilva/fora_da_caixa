...
class TransferValueUpdateView extends StatefulWidget {
  ...
  @override
  _TransferValueUpdateViewState createState() => _TransferValueUpdateViewState();
}
...
class _TransferValueUpdateViewState extends State<TransferValueUpdateView> {
  ...
  ElevatedButton _elevatedButtonUpdateValue() {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(primary: _currentValueInTextField() > 0.0 ? Theme.of(context).primaryColor : Theme.of(context).disabledColor),
      onPressed: () {
        setState(() {

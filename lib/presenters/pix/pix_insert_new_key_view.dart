...
import 'package:fora_da_caixa/design_system/button/elevated_button_fc.dart';
import 'package:fora_da_caixa/presenters/pix/pix_token_view.dart';
...
class PixInsertNewKeyView extends StatefulWidget {
  ...
  const PixInsertNewKeyView({Key? key, required this.user, required this.enumPixKeyType}) : super(key: key);

  @override
  _PixInsertNewKeyViewState createState() => _PixInsertNewKeyViewState();
}

...
import 'package:fora_da_caixa/presenters/pix/pix_copy_and_paste_view.dart';
import 'package:fora_da_caixa/presenters/pix/pix_favorites_view.dart';
import 'package:fora_da_caixa/presenters/pix/pix_keys_view.dart';
import 'package:fora_da_caixa/presenters/pix/pix_qrcode_view.dart';
import 'package:fora_da_caixa/presenters/pix/pix_receive_view.dart';
...
import 'package:fora_da_caixa/design_system/modal_bottom_sheet/head_modal_bottom_sheet.dart';
...
class PixView extends StatefulWidget {
  ...
  const PixView({Key? key, required this.user, required this.listUserAccount}) : super(key: key);

  @override
  _PixViewState createState() => _PixViewState();
}
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('Movimentações', style: Theme.of(context).textTheme.headline3),
          ),

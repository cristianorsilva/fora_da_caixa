...
import 'package:fora_da_caixa/presenters/pix/pix_insert_new_key_view.dart';
...
class PixKeysView extends StatefulWidget {
  ...
  const PixKeysView({Key? key, required this.user, required this.listUserPixKey}) : super(key: key);

  @override
  _PixKeysViewState createState() => _PixKeysViewState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Minhas Chaves', style: Theme.of(context).textTheme.headline2),
      ),
      body: Container(
